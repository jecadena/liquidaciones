        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container">
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            <h2 class="text-center mb-4">Reportes por cliente</h2>
                        </div>
                    </div>    
                    <div class="row bg-light">
                        <div class="col-lg-3 mt-4 mb-1">
                        ...
                        <div class="col-lg-3 mt-4 mb-1">
                            <label for="tipo_liquidacion">Observaciones:</label>
                            <input type="text" class="form-control" id="de_obs_control_doc" name="de_obs_control_doc">
                        </div>
                        <div class="col-lg-3 mt-4 mb-1">
