        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container">
                    ...
                    <div id="nuevoIntento" style="display: none;"><button type="button" id="nuevoLanzamiento" class="btn btn-primary btn-block">REGRESAR A LIQUIDACIONES</button></div>
                    <div class="row bg-light" id="contenido">
                        ...
                        <div class="col-lg-2 mt-3 mb-1">
                            ...
                            <input type="text" class="form-control" id="nu_liquidacion" name="nu_liquidacion">
                        </div>
                        <div class="col-lg-2 mt-3 mb-1">
                            <form id="uploadForm1" enctype="multipart/form-data">
                                <input type="hidden" id="liquidacion" name="liquidacion" value="">
                                <input type="hidden" id="tipo" name="liquidacion" value="">
                                ...
                                <button type="button" id="guardarDatos" class="btn btn-primary btn-block mt-4" style="display:none;">
                ...
                <script>
                    ...
                    $(document).ready(function(){
                        ...
                        $('#nuevoLanzamiento').on('click', function () {
                            $('#nuevoIntento').hide();
